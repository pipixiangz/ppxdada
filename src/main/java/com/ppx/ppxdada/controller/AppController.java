...
import com.ppx.ppxdada.model.dto.app.AppAddRequest;
import com.ppx.ppxdada.model.dto.app.AppEditRequest;
import com.ppx.ppxdada.model.dto.app.AppQueryRequest;
import com.ppx.ppxdada.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Long> addApp(@RequestBody AppAddRequest appAddRequest, HttpServletRequest request) {
        // 如果 appAddRequest 为空（即 null），那么 ThrowUtils.throwIf 方法将抛出错误
